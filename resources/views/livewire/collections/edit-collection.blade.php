<div class="p-6 bg-white shadow-md rounded-2xl">
    <div class="flex items-center justify-between mb-4">
        <h1 class="text-2xl font-semibold">Edycja zbiórki</h1>
        <a href="{{ route('collections.show', $this->collectionModel) }}" class="text-blue-600 hover:underline">← Powrót do szczegółów</a>
    </div>

    <form wire:submit.prevent="update" class="grid gap-4 max-w-3xl">
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <a href="{{ route('collections.show', $this->collectionModel) }}" class="text-gray-700 hover:underline">Anuluj</a>
        </div>
    </form>
</div>
